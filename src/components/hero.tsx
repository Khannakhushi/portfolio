...
function Hero() {
  return (
    <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto max-w-5xl px-5 sm:px-6 py-20 sm:py-32">
        <div className="grid gap-10 md:grid-cols-[1fr_auto] md:items-center md:gap-12 lg:gap-20">
          ...
          <div className="flex flex-col">
            ...
            <motion.h1
              className="font-serif text-5xl leading-[1.05] tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl"
            ...
            <motion.p
              className="mt-6 sm:mt-8 max-w-lg text-sm leading-relaxed text-muted-foreground sm:text-base md:text-lg"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
            >
              Software Engineer at JPMorgan Chase & Co. building scalable financial technology.
              Previously at Amazon and USAA. Passionate about crafting systems
              that are as elegant as they are robust.
            </motion.p>
            ...
            >
              <Link
                ...
                className="group inline-flex items-center gap-2 rounded-full border border-foreground bg-foreground px-5 sm:px-6 py-2.5 sm:py-3 text-sm font-medium text-background transition-all duration-300 hover:bg-transparent hover:text-foreground"
              >
                Resume
          ...
          >
            <div className="relative h-[380px] w-[280px] lg:h-[520px] lg:w-[380px]">
              {/* Frame accent */}
              <div
                className="absolute -right-2 -bottom-2 lg:-right-3 lg:-bottom-3 h-full w-full rounded-2xl"
